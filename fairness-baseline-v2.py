...
file1 = open("output/lambda/baseline/output_baseline.txt","w")
...
fig.savefig('output/lambda/baseline/baseline.png')
...
plt.savefig('output/lambda/baseline/entropy_fig.png')

plt.figure()
plt.plot(plt_clf_loss)
plt.savefig('output/lambda/baseline/clf_loss_fig.png')

plt.figure()
plt.plot(plt_adv_loss)
plt.savefig('output/lambda/baseline/adv_loss_fig.png')
