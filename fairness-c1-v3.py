...
file1 = open("output/lambda/c1-v3/output_c1.txt","w")
...
def test(image_name):
    ...
    for Z_test, Z_test_name in zip(Z_sets, Z_sets_names):
        ...
        fig.savefig('output/lambda/c1-v3/{}_{}.png'.format(image_name, Z_test_name))
...
plt.figure()
plt.savefig('output/lambda/c1-v3/entropy_fig.png')

plt.figure()
plt.savefig('output/lambda/c1-v3/clf_loss_fig.png')

plt.figure()
plt.savefig('output/lambda/c1-v3/adv_loss_fig.png')
