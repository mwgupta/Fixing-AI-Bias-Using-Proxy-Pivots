...
# open output file
file1 = open(f"output/n_cluster/n_{my_n}/output_c1.txt","w")
...
def test(image_name):
    ...
    for Z_test, Z_test_name in zip(Z_sets, Z_sets_names):
        ...
        fig.savefig('output/n_cluster/n_{}/{}_{}.png'.format(my_n, image_name, Z_test_name))
...
plt.figure()
plt.savefig(f'output/n_cluster/n_{my_n}/entropy_fig.png')

plt.figure()
plt.savefig(f'output/n_cluster/n_{my_n}/clf_loss_fig.png')

plt.figure()
plt.savefig(f'output/n_cluster/n_{my_n}/adv_loss_fig.png')
